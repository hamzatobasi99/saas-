...
@router.get("")
async def list_documents(current_tenant: TokenPayload = Depends(get_current_tenant)):
    """
    نقطة النهاية المفقودة التي تطلبها الواجهة الأمامية عند تحميل الصفحة.
    تم إرجاع قائمة فارغة مؤقتاً لضمان استقرار الواجهة حتى يتم دمجها مع قاعدة البيانات.
    """
    return []
